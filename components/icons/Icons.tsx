...
export const RoadmapsIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <Icon {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1.5-1.5m1.5 1.5l1.5-1.5m0 0l-1.5 1.5m1.5-1.5l1.5 1.5M6 6.75h.008v.008H6V6.75z" />
  </Icon>
);
...
export const CheckIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <Icon {...props} className="w-5 h-5" strokeWidth={2}>
...
export const GoogleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" className="w-5 h-5" {...props}>
    ...
    <path fill="#1976D2" d="M43.611 20.083H42V20H24v8h11.303c-0.792 2.237-2.231 4.166-4.087 5.571l6.19 5.238C42.012 34.426 44 29.564 44 24c0-1.341-.138-2.65-.389-3.917z" />
  </svg>
);
...
export const CoffeeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6 9.75V6.75a2.25 2.25 0 012.25-2.25h3a2.25 2.25 0 012.25 2.25v3" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M6 9.75h9.75v6.75a2.25 2.25 0 01-2.25 2.25H8.25a2.25 2.25 0 01-2.25-2.25V9.75z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 9.75v6.75a2.25 2.25 0 002.25 2.25H18v-8.25h-.75a2.25 2.25 0 00-2.25 2.25z" />
    </Icon>
);
