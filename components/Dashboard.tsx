...
const { isGuest, currentUser, upgradeSubscription } = useAuth(); // Import upgradeSubscription
const [isAiModalOpen, setIsAiModalOpen] = useState(false);
const [isNewRoadmapModalOpen, setIsNewRoadmapModalOpen] = useState(false);
const [isAuthModalOpen, setIsAuthModalOpen] = useState(false);
const [isPayPalModalOpen, setIsPayPalModalOpen] = useState(false); // New state
const [authModalMessage, setAuthModalMessage] = useState("");
const [searchTerm, setSearchTerm] = useState('');
const [editingRoadmap, setEditingRoadmap] = useState<Roadmap | null>(null);

// ... (categories and existing useMemos)
